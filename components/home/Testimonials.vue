<template>
  <section class="bg-indigo-800">
    <div class="mx-auto max-w-7xl md:grid md:grid-cols-2 md:px-6 lg:px-8">
        ...
        <blockquote class="mt-6 md:flex md:flex-grow md:flex-col">
          <div class="relative text-lg font-medium text-white md:flex-grow">
            <Icon name="fa6-solid:quote-left"
              class="absolute -top-5 left-0 h-12 w-12 -translate-x-3 -translate-y-2 transform text-indigo-600" />
            <p class="relative">Excelente profissional, super atencioso e dedicado, pronto pra resolver nossas dúvidas e
              questionamentos.... Super indico a todos que queiram um ótimo profissional.</p>
          </div>

          <footer class="mt-8">
            <div class="flex items-center">
              <div class="inline-flex flex-shrink-0 rounded-full border-2 border-white">
                <NuxtImg loading="lazy" width="48" height="48" format="webp" class="h-12 w-12 rounded-full"
      ...
      <div
        class="border-t-2 border-indigo-900 py-12 px-4 sm:px-6 md:border-t-0 md:border-l md:py-16 md:pr-0 md:pl-10 lg:pl-16">
        <blockquote class="mt-6 md:flex md:flex-grow md:flex-col">
          <div class="relative text-lg font-medium text-white md:flex-grow">
            <Icon name="fa6-solid:quote-left"
              class="absolute -top-5 left-0 h-12 w-12 -translate-x-3 -translate-y-2 transform text-indigo-600" />
            <p class="relative">Experiência muito boa. Profissional com uma sabedoria imensa. Eu aconselho!</p>
          </div>
